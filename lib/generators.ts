...
export const DESCRIPTION_PLATFORMS = ['YouTube', 'TikTok', 'Instagram', 'Facebook', 'LinkedIn']
...
export const GENERATOR_TOOLS: GeneratorTool[] = [
  ...
  },
  {
    ...
    groups: HOOK_TYPES,
    inputs: [
      { key: 'topic', label: 'Topic', type: 'text', placeholder: 'e.g. Growing on YouTube in 2025', required: true },
      { key: 'platform', label: 'Platform', type: 'select', optionsSource: 'platforms' },
      { key: 'tone', label: 'Tone', type: 'select', optionsSource: 'tones', brainKey: 'brandVoice' },
    ],
  },
  ...
  },
  {
    ...
    description: 'Generate platform-optimized descriptions tailored for YouTube, TikTok, Instagram, Facebook and LinkedIn.',
    icon: 'AlignLeft',
    accentFrom: '#8B5CF6',
    accentTo: '#06B6D4',
    count: 5,
