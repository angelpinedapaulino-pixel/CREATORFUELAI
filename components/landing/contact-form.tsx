      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <Input id="cf-name" required value={form.name} onChange={(e) => update('name', e.target.value)} placeholder="Your name" className="pl-10" />
          </div>
        </div>
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <Input id="cf-email" type="email" required value={form.email} onChange={(e) => update('email', e.target.value)} placeholder="you@company.com" className="pl-10" />
          </div>
        </div>
      </div>
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <Input id="cf-subject" required value={form.subject} onChange={(e) => update('subject', e.target.value)} placeholder="How can we help?" className="pl-10" />
        </div>
      </div>
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <Textarea id="cf-message" required rows={5} value={form.message} onChange={(e) => update('message', e.target.value)} placeholder="Tell us a bit more..." className="pl-10" />
        </div>
      </div>
