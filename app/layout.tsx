...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Generate on-brand content for YouTube, Instagram, TikTok, LinkedIn and more — powered by your own Business Brain.',
    url: siteUrl,
    siteName: 'CreatorFuel AI',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'CreatorFuel AI' }],
    type: 'website',
  },
  twitter: {
    ...
    title: 'CreatorFuel AI — AI-powered content creation',
    description:
      'Generate on-brand content for every platform, powered by your own Business Brain.',
    images: ['/og-image.png'],
  },
}
